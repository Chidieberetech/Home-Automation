...
& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint a2lox13y97hkm4-ats.iot.eu-central-1.amazonaws.com --ca_file root-CA.crt --cert GarageController.cert.pem --key GarageController.private.key --client_id basicPubSub --topic sdk/test/python --count 0